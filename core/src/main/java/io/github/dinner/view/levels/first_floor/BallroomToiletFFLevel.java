...
public class BallroomToiletFFLevel extends LevelState {
    private String floorType = "wood";

    public BallroomToiletFFLevel() {
        super();

        this.map = new TmxMapLoader().load("map/1st Floor/Ballroom toilet/Ballroom Toilet.tmx");
        ...
        this.name = "ballroomToiletFFLevel";
    }

    @Override
    public void init() {
        InteractableObject WestCorridorEntrance = new InteractableObject(new Rectangle(16, 4, 1, 1), true) {
            @Override
