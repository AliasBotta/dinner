...
public class ClosetFFLevel extends LevelState {
    private String floorType = "wood";

    public ClosetFFLevel() {
        super();

        this.map = new TmxMapLoader().load("map/1st Floor/Closet/Closet.tmx");
    ...
    @Override
    public void init() {
        InteractableObject eastCorridorEntrance = new InteractableObject(new Rectangle(7, 1, 1, 1), true) {
            @Override
