...
public class GenericBathroomSFLevel extends LevelState {
    private String floorType = "wood";

    public GenericBathroomSFLevel() {
        super();

        this.map = new TmxMapLoader().load("map/2nd Floor/Generic Bathroom 2nd Floor/Bathroom.tmx");
        ...
        this.name = "genericBathroomSFLevel";
    }

    @Override
    public void init() {
        InteractableObject eastCorridorEntrance = new InteractableObject(new Rectangle(18, 4, 1, 1), true) {
            @Override
