...
public class OwnerBathroomSFLevel extends LevelState {
    private String floorType = "wood";

    public OwnerBathroomSFLevel() {
        super();

        this.map = new TmxMapLoader().load("map/2nd Floor/OwnerBathroom/OwnerBathroom.tmx");
    ...
    @Override
    public void init() {
        InteractableObject ownerRoomEntrance = new InteractableObject(new Rectangle(8, 1, 1, 1), true) {
            @Override
