...
public class Room3SFLevel extends LevelState {
    private String floorType = "wood";

    public Room3SFLevel() {
        super();

        this.map = new TmxMapLoader().load("map/2nd Floor/Room 3/Room3.tmx");
    ...
    public void init() {
        ...
        InteractableObject computer = new InteractableObject(new Rectangle(16, 5, 1, 1), true) {
            @Override
            public void interact(Player player) {
                Dinner.gameState = Dinner.GameState.COMPUTER;
            }
        };
        interactableObjectController.add(computer);
    }
